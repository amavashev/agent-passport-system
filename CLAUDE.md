...
- SDK: v1.36.2 — 2497 tests, 626 suites, 103 modules (71 core + 32 v2)
- MCP: v2.21.0 — 132 tools
...
## Tests
`npm test` runs all 2497 tests. Test files are manually listed in package.json — new test files must be added to the list.
