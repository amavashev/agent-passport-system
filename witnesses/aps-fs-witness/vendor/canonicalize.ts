...
// ══════════════════════════════════════════════════════════════════
//
// VENDOR NOTE (aps-fs-witness): byte-identical copy of
// src/v2/instruction-provenance/canonicalize.ts on
// feat/v2-instruction-provenance. The only change is the import path
// for canonicalizeJCS, which now resolves to ./canonical-jcs.js instead
// of ../../core/canonical-jcs.js. Do not edit the algorithm here —
// edits here would silently break byte-parity with the IPR module.
// ══════════════════════════════════════════════════════════════════
