...
**106 tools across all 47 modules, role-scoped access control.** Identity, delegation, agora, values/policy, coordination, and commerce — all accessible via MCP. Every operation Ed25519 signed. Auto-configures Claude Desktop and Cursor.
...
```bash
npm test
# 1436 tests across 58 files, 377 suites, 0 failures
```
...
tests/                  73 test files, 1436 tests (377 suites)
