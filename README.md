...
**8 layers. 313 tests. Zero heavy dependencies. Running code. MCP server included.**
...
```bash
npm test
# 313 tests across 15 files, 84 suites, 0 failures
```
...
tests/                  20 test files, 313 tests (84 suites)
