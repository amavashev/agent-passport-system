...
[![tests](https://img.shields.io/badge/tests-264%20passing-brightgreen)](https://github.com/aeoess/agent-passport-system)
...
**8 layers. 264 tests. Zero heavy dependencies. Running code. MCP server included.**
...
```bash
npm test
# 264 tests across 15 files, 71 suites, 0 failures
```
...
tests/                  17 test files, 264 tests (71 suites)
