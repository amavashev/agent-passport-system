...
20 essential tools by default. Set `APS_PROFILE=full` for all 146 tools. Profiles: essential, identity, governance, coordination, commerce, data, gateway, comms, minimal, full.
