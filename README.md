...
**8 layers. 394 tests. Zero heavy dependencies. Running code. MCP server included.**
...
```bash
npm test
# 394 tests across 22 files, 118 suites, 0 failures
```
...
tests/                  22 test files, 394 tests (118 suites)
