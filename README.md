...
[![tests](https://img.shields.io/badge/tests-1493%20passing-brightgreen)](https://github.com/aeoess/agent-passport-system)
...
42 core modules + 32 v2 constitutional modules. 1493 tests. Zero heavy dependencies.
...
```bash
npm test
# 1493 tests across 76 files, 388 suites, 0 failures
```
...
| Tests | 1493 (50 adversarial) | None | Limited | None | None |
