...
```bash
npm install agent-passport-system        # SDK (97 modules)
...
- **97 modules** (65 core + 32 v2 constitutional)
- **2,009 tests** including 50 adversarial attack scenarios
