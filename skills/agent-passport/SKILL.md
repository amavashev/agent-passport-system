...
```bash
npm install agent-passport-system        # SDK (96 modules)
...
- **96 modules** (64 core + 32 v2 constitutional)
- **1,987 tests** including 50 adversarial attack scenarios
