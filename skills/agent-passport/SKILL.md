...
- **2,972 tests** including 50 adversarial attack scenarios
- **Zero heavy dependencies** — Node.js crypto + uuid only
- **Apache-2.0** license
- *Full surface area: 123 modules, 154 MCP tools — available under `APS_PROFILE=full` and the root `agent-passport-system` import.*
